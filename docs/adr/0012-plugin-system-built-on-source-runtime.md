...
LX Compatibility is a core product capability. Separately, Fika needs a way to ship bundled integrations and eventually let users install online music source packages. These are related but distinct concerns:
