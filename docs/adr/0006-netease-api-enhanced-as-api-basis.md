...
- Bridge mode was later resolved by ADR 0009: no Node runtime and no QuickJS bundle; rewrite selected endpoint behavior in Rust.
- Credential handling was later resolved by ADR 0010: Source Providers receive opaque account refs, and the trusted Service Bridge attaches secrets internally.
