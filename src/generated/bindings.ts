...
export type OnlineAlbumPage = { items: Array<OnlineAlbum>, hasMore: boolean, total: number | null, };

export type OnlineArtist = { key: string, name: string, coverUrl: string | null, candidates: Array<OnlineArtistCandidate>, };

export type OnlineArtistBiography = { summary: string | null, sections: Array<OnlineArtistBiographySection>, sourceName: string, };

export type OnlineArtistBiographySection = { title: string, text: string, };
...
export type OnlineMusicSettings = { excludedChannels: Array<string>, channelPriority: Array<string>, audioSourceSelectionMode: AudioSourceSelectionMode, audioSourcePriority: Array<string>, layerTimeoutSeconds: number, playbackTimeoutSeconds: number, playbackQuality: SourceQuality, playbackCacheMaxMb: number, downloadQuality: SourceQuality, autoFavoriteOnDownload: boolean, searchHistoryEnabled: boolean, downloadDirectory: string | null, filenameTemplate: string, downloadConcurrency: number, batchNotifications: boolean, };
...
export type SourceArtistBiography = { summary: string | null, sections: Array<SourceArtistBiographySection>, };

export type SourceArtistBiographySection = { title: string, text: string, };
...
export type SourceComment = { id: string, userName: string, avatarUrl: string | null, content: string, timestampMs: number | null, timeLabel: string | null, likedCount: number, replyCount: number, location: string | null, };

export type SourceCommentsResponse = { hotComments: Array<SourceComment>, comments: Array<SourceComment>, total: number | null, hasMore: boolean, };
...
export type SourceRequest = { "action": "musicSearch", source: string, keyword: string, page: number, pageSize: number, } | { "action": "artistSearch", source: string, keyword: string, page: number, pageSize: number, } | { "action": "albumSearch", source: string, keyword: string, page: number, pageSize: number, } | { "action": "playlistSearch", source: string, keyword: string, page: number, pageSize: number, } | { "action": "searchSuggestions", source: string, keyword: string, limit: number, } | { "action": "artistTopTracks", source: string, artist: SourceEntityRef, limit: number, } | { "action": "artistAlbums", source: string, artist: SourceEntityRef, page: number, pageSize: number, } | { "action": "artistBiography", source: string, artist: SourceEntityRef, } | { "action": "albumRead", source: string, album: SourceEntityRef, page: number, pageSize: number, } | { "action": "playlistReadPublic", source: string, playlist: SourceEntityRef, page: number, pageSize: number, } | { "action": "musicUrl", source: string, musicInfo: Record<string, unknown>, quality: SourceQuality, } | { "action": "lyric", source: string, musicInfo: Record<string, unknown>, } | { "action": "pic", source: string, musicInfo: Record<string, unknown>, } | { "action": "musicComments", source: string, musicInfo: Record<string, unknown>, page: number, pageSize: number, } | { "action": "musicRecommendations", source: string, accountRef: string, kind: MusicRecommendationKind, limit: number, } | { "action": "playlistList", source: string, accountRef: string, } | { "action": "playlistRead", source: string, accountRef: string, playlistId: string, } | { "action": "playlistAddTrack", source: string, accountRef: string, playlistId: string, track: SourceTrackRef, } | { "action": "playlistRemoveTrack", source: string, accountRef: string, playlistId: string, track: SourceTrackRef, };

export type SourceRequestOutcome = { response: SourceResponse, diagnostics: Array<SourceDiagnostic>, };

export type SourceResponse = { "action": "musicSearch", "data": SourceSearchResponse } | { "action": "artistSearch", "data": SourceArtistSearchResponse } | { "action": "albumSearch", "data": SourceAlbumSearchResponse } | { "action": "playlistSearch", "data": SourcePlaylistSearchResponse } | { "action": "searchSuggestions", "data": SourceSuggestionsResponse } | { "action": "artistTopTracks", "data": SourceSearchResponse } | { "action": "artistAlbums", "data": SourceAlbumSearchResponse } | { "action": "artistBiography", "data": SourceArtistBiography } | { "action": "albumRead", "data": SourceSearchResponse } | { "action": "playlistReadPublic", "data": SourceSearchResponse } | { "action": "musicUrl", "data": string } | { "action": "lyric", "data": LyricResponse } | { "action": "pic", "data": string } | { "action": "musicComments", "data": SourceCommentsResponse } | { "action": "musicRecommendations", "data": SourceRecommendationsResponse } | { "action": "playlistList", "data": Array<SourcePlaylist> } | { "action": "playlistRead", "data": SourcePlaylistDetail } | { "action": "playlistAddTrack", "data": SourcePlaylistMutation } | { "action": "playlistRemoveTrack", "data": SourcePlaylistMutation };
...
export const TAURI_COMMANDS = {
  ...
  onlineMusicArtistAlbums: "online_music_artist_albums",
  onlineMusicArtistBiography: "online_music_artist_biography",
